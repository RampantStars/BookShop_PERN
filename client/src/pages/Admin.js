...
import CreateType from '../components/modals/CreateTypes';
...
const Admin = () => {
  ...
  return (
    <Container className='d-flex flex-column'>
      ...
      <Button variant='outline-dark' className=' mt-4 p-2' onClick={() => setGenreVisible(true)}>
        Добавить жанр
      </Button>
      <Button variant='outline-dark' className=' mt-4 p-2' onClick={() => setAuthorVisible(true)}>
        Добавить автора
      </Button>
      <Button variant='outline-dark' className=' mt-4 p-2' onClick={() => setBookVisible(true)}>
        Добавить книгу
      </Button>
